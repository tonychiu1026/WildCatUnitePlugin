...
public class GetAssociateAndValidateResult extends BDSCodeCenterSample {
	...
	static Logger log = Logger.getLogger(GetAssociateAndValidateResult.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
			...
			pageFilter.setLastRowIndex(200);
			...
			try {
			requestsList = appApi.searchApplicationRequests((ApplicationNameVersionOrIdToken)apptoken, "IP Plan Approval", pageFilter);
